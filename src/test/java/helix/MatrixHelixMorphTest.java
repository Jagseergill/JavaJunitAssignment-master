...
public class MatrixHelixMorphTest {
    ...
    public void test3x2(){
        ...
        int[][] expOutput ={{2,1},{2,2},{2,3}};
        assertTrue(testEqual(expOutput, MatrixHelixMorph.helix(inMatrix)));
    }
    @Test
    public void test4(){
        int[][] inMatrix= {{1,1,3},{1,3,5}};
    ...
    @Test
    public void test6(){
        int[][] inMatrix = {{1,2,3,4},{1,2,1,3}};
        int[][] expOutput = {{1,2,3,2},{1,2,3,4}};
        assertTrue(testEqual(expOutput,MatrixHelixMorph.helix(inMatrix)));
    }
    @Test
    public void test7(){
    ...
    @Test
    public void test8(){
        int[][] inMatrix = {{1,2},{1,1},{1,3},{4,5}};
        int[][] expOutput = {{1,3},{1,3},{1,3},{1,7}};
        assertTrue(testEqual(expOutput,MatrixHelixMorph.helix(inMatrix)));
    }
    @Test
    public void test9(){
        int[][] inMatrix = {{2},{1},{1},{4}};
        int[][] expOutput = {{1},{3},{3},{7}};
        assertTrue(testEqual(expOutput,MatrixHelixMorph.helix(inMatrix)));
    }
    @Test
    public void test10(){
        int[][] inMatrix = {{1,2},{1,1},{1,3},{4,5},{7,5},{4,1}};
        int[][] expOutput = {{1,3},{1,3},{1,3},{1,7},{1,5},{4,3}};
        assertTrue(testEqual(expOutput,MatrixHelixMorph.helix(inMatrix)));
    }
